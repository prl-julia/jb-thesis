...
type requires a subtype check for an arbitrary \cjl{t}.

Existential types serve at least two purposes in the Julia language.
...
of the original design of the Julia language~\cite{TODO}.
