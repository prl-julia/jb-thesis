...
\label{lem:sub-var-right-sub-ub}
    ...
    \tyvld{}{\AEnv},\ \tyvlddflt{\ty},$ 
    $\tyvlddflt{\plug\dctx\vany},  
    \varbound{\vany}{\tylb}{\tyub} \in \AEnv,
    \text{ and }
    (\forall \ty' \text{ with } \tyvlddflt{\ty'} \text{ and } 
    \tymsrdflt{\ty'} \leq \tymsrdflt{\ty}.\ 
    \subtydflt{\ty'}{\tylb} \implies \subtydflt{\ty'}{\tyub}).$
    \[
        \subtydflt{\ty}{\plug\dctx\vany}
        \quad\implies\quad
        \subtydflt{\ty}{\plug\dctx\tyub}.
    \] 
\end{lemma}
\begin{proof}
    By induction on \subtydflt{\ty}{\plug\dctx\vany}.
    The transitivity assumption
    ($\forall \ty'\ldots\ \subtydflt{\ty'}{\tylb} \implies \subtydflt{\ty'}{\tyub}$)
    carries to the induction hypothesis because for each premise
    \subtydflt{\ty'}{\ty''} of \subtydflt{\ty}{\plug\dctx\vany},
    it holds that $\tymsrdflt{\ty'} \leq \tymsrdflt{\ty}.$
    ...
    \begin{itemize}
        ...
        \item \textbf{Case \RST{VarRight}}. \subtydflt{\ty}{\vany}.
            By the form of the rule, $\varbound{\vany}{\tylb}{\tyub} \in \AEnv$
            and \subtydflt{\ty}{\tylb}.
            Since $\tymsrdflt{\ty} \leq \tymsrdflt{\ty},$ by the transitivity 
            assumption, \subtydflt{\ty}{\tyub}.
