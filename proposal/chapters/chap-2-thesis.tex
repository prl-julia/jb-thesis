...
(OOPSLA 2018~\cite{zappa-nardelli:julia-sub:oopsla:2018}),
and defined and mechanized a set-theoretic model of a subset of Julia types
(FTfJP 2019~\cite{belyakova:minijl-sub:ftfjp:2019});
...
\cjl{eval}~\cite{belyakova:world-age:oopsla:2020}
and the JIT compiler~\cite{pelenitsyn:type-stability:oopsla:2021},
